import{r as l,m as u,c as f,F as m,j as n,n as x,i as b,_ as C}from"./index-6af8e44a.js";import{q as g}from"./useKey-638cd7f9.js";const h=({question:e})=>{const i=l.useRef(u()).current;function r(){if(!e)return;const a=Object.entries(e).reduce((t,[o,s])=>{if(o==="question")return t+`${o}: ${s}
