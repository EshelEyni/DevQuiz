import{r as l,m as u,c as f,F as m,j as n,n as x,i as b,_ as C}from"./index-f6843686.js";import{q as g}from"./useKey-6ff6dcbf.js";const h=({question:e})=>{const i=l.useRef(u()).current;function r(){if(!e)return;const a=Object.entries(e).reduce((t,[o,s])=>{if(o==="question")return t+`${o}: ${s}
