import{r as l,m as u,c as f,F as m,j as n,n as x,i as b,_ as C}from"./index-bd1c9fc0.js";import{q as g}from"./useKey-a30a1829.js";const h=({question:e})=>{const i=l.useRef(u()).current;function r(){if(!e)return;const a=Object.entries(e).reduce((t,[o,s])=>{if(o==="question")return t+`${o}: ${s}
